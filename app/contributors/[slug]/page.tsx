...
export default async function ContributorProfile({
  ...
  const totalAttendees = meetups.reduce((s, m) => s + m.attendeesTotal, 0);
  const totalNew = meetups.reduce((s, m) => s + m.attendeesNewToZcash, 0);
          ...
          <>
            <div className="mt-8 grid grid-cols-3 gap-3">
              <div className="card p-4 text-center">
                <div className="text-2xl font-bold text-gold">{meetups.length}</div>
